...
class RecruitersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recruiter" do
    assert_difference('Recruiter.count') do
      post recruiters_url, params: { recruiter: { cnpj: @recruiter.cnpj, description: @recruiter.description, telephone: @recruiter.telephone } }
    end
  ...
  test "should update recruiter" do
    patch recruiter_url(@recruiter), params: { recruiter: { cnpj: @recruiter.cnpj, description: @recruiter.description, telephone: @recruiter.telephone } }
