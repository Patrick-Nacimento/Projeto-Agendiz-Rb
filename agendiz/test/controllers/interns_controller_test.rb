...
class InternsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create intern" do
    assert_difference('Intern.count') do
      post interns_url, params: { intern: { age: @intern.age, defect: @intern.defect, description: @intern.description, quality: @intern.quality, telephone: @intern.telephone } }
    end
  ...
  test "should update intern" do
    patch intern_url(@intern), params: { intern: { age: @intern.age, defect: @intern.defect, description: @intern.description, quality: @intern.quality, telephone: @intern.telephone } }
